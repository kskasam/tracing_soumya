    ...
    if (currentOfTracking == StateOfTracing.traceShapes) {
      ...
      for (var char in chars) {
        ...
        if (_isArabicCharacter(letters)) {
          ...
          // Check for Telugu characters (Unicode block U+0C00 - U+0C7F)
          if (_isTeluguCharacter(letters)) {
            tracingDataList.add(
                _getTracingDataTelugu(letter: letters).first.copyWith(
                      innerPaintColor: char.traceShapeOptions.innerPaintColor,
                      outerPaintColor: char.traceShapeOptions.outerPaintColor,
                      indexColor: char.traceShapeOptions.indexColor,
                      dottedColor: char.traceShapeOptions.dottedColor,
...
// Helper functions to detect the type of letter
  ...
  List<TraceModel> _getTracingDataTelugu(
    ...
    switch (letter) {
      ...
      case 'అ': // a
        list.add(_createTeluguTraceModel(
          ...
          bigPath: TeluguShapePaths.aBig,
          smallPath: TeluguShapePaths.aSmall,
      ...
      case 'ఋ': // ru
        list.add(_createTeluguTraceModel(
          sizeOfLetter: sizeOfLetter,
          bigPath: TeluguShapePaths.ruBig,
          smallPath: TeluguShapePaths.ruSmall,
          dottedPath: TeluguShapePaths.ruDotted,
      ...
      case 'ౠ': // ruu
        list.add(_createTeluguTraceModel(
          sizeOfLetter: sizeOfLetter,
          bigPath: TeluguShapePaths.ruuBig,
          smallPath: TeluguShapePaths.ruuSmall,
          dottedPath: TeluguShapePaths.ruuDotted,
      ...
      case 'అం': // am
        list.add(_createTeluguTraceModel(
          sizeOfLetter: sizeOfLetter,
          bigPath: TeluguShapePaths.amBig,
          smallPath: TeluguShapePaths.amSmall,
          dottedPath: TeluguShapePaths.amDotted,
      ...
      case 'అః': // aha
        list.add(_createTeluguTraceModel(
          sizeOfLetter: sizeOfLetter,
          bigPath: TeluguShapePaths.ahaBig,
          smallPath: TeluguShapePaths.ahaSmall,
          dottedPath: TeluguShapePaths.ahaDotted,
  ...
  List<TraceModel> _getTracingDataNumbers(
      {required String number, Size sizeOfLetter = const Size(240, 240)}) {
    ...
    switch (currentLetter) {
      case MathShapes.circle:
        final circ = TraceModel(
            letterViewSize: const Size(240, 240),
  ...
  List<TraceModel> _getTracingDataPhonicsUp(
    ...
    switch (currentLetter) {
      ...
      case PhonicsLetters.o:
        return [
          _getTracingDataPhonics(
                  letter: 'o', sizeOfLetter: const Size(240, 240))
              .first,
        ];
      ...
      case PhonicsLetters.w:
        return [
          _getTracingDataPhonics(
                  letter: 'w', sizeOfLetter: const Size(240, 240))
              .first,
        ];
      case PhonicsLetters.e:
        return [
      ...
      case PhonicsLetters.s:
        ...
        return [
          _getTracingDataPhonics(
                  letter: 's', sizeOfLetter: const Size(240, 240))
              .first,
        ];
      case PhonicsLetters.a:
        return [
      ...
      case PhonicsLetters.k:
        return [
          _getTracingDataPhonics(
                  letter: 'k', sizeOfLetter: const Size(240, 240))
              .first,
        ];
      case PhonicsLetters.q:
        return [
      ...
      case PhonicsLetters.v:
        return [
          _getTracingDataPhonics(
                  letter: 'v', sizeOfLetter: const Size(240, 240))
              .first,
        ];
      case PhonicsLetters.x:
        return [
          _getTracingDataPhonics(
                  letter: 'x', sizeOfLetter: const Size(240, 240))
              .first,
        ];
      case PhonicsLetters.y:
        return [
          _getTracingDataPhonics(
                  letter: 'y', sizeOfLetter: const Size(240, 240))
              .first,
        ];
      case PhonicsLetters.z:
        return [
          _getTracingDataPhonics(
                  letter: 'z', sizeOfLetter: const Size(240, 240))
              .first,
        ];
      case PhonicsLetters.t:
        return [
